export default class HiNavigator {
    ...
    static navigateToInputDrugPage({classify, step, count}) {
    ...
    static navigateToDrugNumberPage({classify, drugName, step, count}) {
        this.navigateTo({url: `/pages/add-drug/number/number?classify=${classify}&drugName=${drugName}&step=${step}&count=${count}`})
    }
}
